...
<html>
<head>
	<title>Nexera Medical - Antimicrobial Protection that is Committed to Preserving Health. - Professional Series</title>
...
<img src="../graphics/logo_spectrashield.png" width="400" height="100" border="0" alt="SpectraShield">
<br />

<div style="float: right; text-align: center; padding: 20px 10px 20px 10px;"><img src="../graphics/prod_img_guardian1.jpg" width="150" height="225" border="0" alt="Guardian Series Respirator Mask">
</div>

<h1 class="hdtitlemain">The "Guardian" Reusable - Respirator Masks</h1>

<strong>European Union</strong>

<ul>
<li>	E.U. Cleared Antimicrobial FFP2RD Reusable respirator</li>
<li>	Tested for extended wear for up to 12 hours in a single use</li>
<li>	Can be reused up to 14 days</li>
<li>	Highly fluid resistant</li>
<li>	PVC Free / Latex Free / Non-allergenic</li>
<li>	Available in 2-pack retail and 24 pack or 50 pack institutional</li>
<li>    Continuously kills and inactivates bacteria and viruses for 14 days</li>
<li>	Approved with a CE Mark under EN149:2001 + A1:2009</li>
</ul>

<div style="border: 3px #CCCCCC dotted; padding: 10px 10px 10px 10px; margin: 0px 20px 20px 20px; width: 180px">
<a href="../dfiles/Guardian_FFP2.pdf" target="_blank"><img src="../graphics/icon_pdf_50.png" alt="Download PDF" border="0" align="left" /> <strong>Download the<br />FFP2</strong> Datasheet</a>
</div>

<div align="center">
<img src="../graphics/hp_product_sample2a.png" width="300" height="285" border="0" alt="SpectraShield Guardian FFP2 RD Mask">
<img src="../graphics/hp_product_sample2b.png" width="300" height="285" border="0" alt="SpectraShield Guardian FFP2 RD Mask">
</div>
	
<div style="text-align: center; padding: 20px 10px 20px 10px;"><img src="../graphics/img_guardian.jpg" width="660" height="440" border="0" alt="The Guardian Series - Respirator Masks">
...
<div style="font-size: 10pt; padding: 0px 10px 10px 50px; line-height: 18pt;">
<a href="../cfiles/products_guardian.php">&middot; &nbsp; Guardian FFP2 RD</a><br />
	<!--
<a href="../cfiles/products_defender.php">&middot; &nbsp; Defender N99</a><br />
	-->
</div>
