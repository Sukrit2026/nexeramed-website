...
<html>
<head>
	<title>Nexera Medical - Antimicrobial Protection that is Committed to Saving Lives. - Nexera Regulatory Information</title>
...
<!--- *************************** UNITED STATES STARTS HERE *********************** --->
<!---
--->

<!--- *************************** CANADA STARTS HERE *********************** --->

<!--- *************************** EUROPEAN UNION STARTS HERE *********************** --->
<CFSET session.regionsiteid="eu">
<div class="hdtitlemain">The SpectraShield Guardian FFP2 RD is the first ever Reusable Antimicrobial Respirator Masks to earn a CE Mark
</div>

<!--
<table width="200" border="0" align="right"><tr><td valign="top"><img src="../graphics/mask_img_eu.jpg" border="0" width="180" height="260" alt="SpectraShield"></td></tr>
<tr><td align="center"><div style="font-size: 14pt;">FFP3</div></td></tr>
</table>
-->

<ul>
<li>Continuously Kills Bacteria and Inactivates Viruses </li>
<li>Exceeds 99% plus filtration efficiency against Bacteria and Viruses</li>
<li>Kills MS-2, MRSA, Haemophilus influenza, Legionella pneumophila and Streptococcus pyogenes, TB.</li>
<li>Inactivates SARS, Bird Flu (H5N1), Influenza A, Human Rhinovirus, Adenovirus.</li>
</ul>

<!---
<table width="400" border="0" align="center"><tr><td valign="top"><img src="../graphics/ss9900eu.jpg" border="0" width="350" height="260" alt="SpectraShield 9900"></td></tr></table>
--->

<!--
<br>
<strong>The SpectraShield&trade; Plus FFP3 Antimicrobial Respirator Mask provides:</strong>
<br>

<ol>
<li>Superior filtration of FFP3 performance (French Standard).</li>
<li>Continuous antimicrobial protection against viruses and bacteria.</li>
<li>99.9% filtration efficiency against viruses and bacteria as small as .03 microns.</li>
<li>Exceeds the World Health Organization ("WHO")  ( <a href="http://www.who.int/en" target="new">www.who.int/en</a> ) guidelines for protection against infectious microbial threats such as Avian Influenza, SARS and Tuberculosis.</li>
<li>Patented proven technology incorporating a U.S. Environmental Protection Agency ("EPA") approved antimicrobial agent which is embedded into the fiber for enhanced protection.</li>
<li>Reduces mask odor caused by bacterial growth.</li>
<li>Continuously self-sanitizes itself for extended use.</li>
<li>Natural nontoxic antimicrobial agent is safe for wear.</li>
</ol>
<br><br>
-->


<!--- *************************** OTHER LOCATIONS STARTS HERE *********************** --->
...
<tr>
<td valign="top" bgcolor="#EEEEEE" width="206">
<!---
<CFINCLUDE template="..\includes\subsect_products.php">
<cfif cgi.SCRIPT_NAME contains "regulatory.php" and region eq "US">

<span <cfif sectsubnav eq "masks">class="sectsubnavon"<cfelse>class="sectsubnav"</cfif>>
<a href="../cfiles/products_professional.php">&middot; &nbsp; Professional N95</a><br />
</span>
...
<!---<li> <a href="../cfiles/regulatory.php?region=OT">All Other Locations</a><br><br>--->
